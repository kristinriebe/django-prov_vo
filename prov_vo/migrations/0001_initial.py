    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('collection', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='prov_vo.Entity')),
                ('entity', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='collection', to='prov_vo.Entity')),
            ],
        ),
        migrations.CreateModel(
            name='Used',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(primary_key=True, serialize=False)),
                ('generatedEntity', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='prov_vo.Entity')),
                ('usedEntity', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='generatedEntity', to='prov_vo.Entity')),
            ],
        ),
        migrations.CreateModel(
            name='WasGeneratedBy',
